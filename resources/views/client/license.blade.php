...
<div class="container-fluid">
    ...
    <div class="col" style="margin: 11px;width: 653px;">
            <div class="card shadow mb-3">
                ...
                <div class="card-body" style="color: rgb(255,255,255);padding: 22px;width: 626px;height: 190px;">
                    <form>
                        <div class="form-row">
                            <div class="col" style="width: 374px;height: 88px;margin: 2px;padding: 4px;">
                                <div class="form-group"><label for="username" style="font-family: 'Roboto Condensed', sans-serif;color: rgb(38,33,33);"><strong>УЛСЫН</strong>&nbsp;<strong>ДУГААРАА ОРУУЛНА УУ</strong><br></label><input class="form-control" type="text" placeholder="XXXXУБА" name="search" style="font-family: 'Roboto Condensed', sans-serif;"></div>
                            </div>
                            <div class="col" style="height: 18px;">
                                <div class="form-group" style="padding: -13px;width: 355px;height: -13px;margin: 1px;">
                                    <div class="card shadow border-left-info py-2" style="height: 80px;color: rgb(22,24,40);margin: 5px;opacity: 1;padding: 36px;width: 333px;">
                                        <div class="card-body text-white" style="width: 299px;height: 54px;font-size: 10px;margin: -8px;padding: 29px;"><input type="file" style="width: 239px;height: 53px;margin: -5px;padding: -6px;font-size: 17px;color: rgb(23,20,20);font-family: 'Roboto Condensed', sans-serif;"></div>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="form-group"><button class="btn btn-primary btn-sm" type="submit" style="font-family: 'Roboto Condensed', sans-serif;background-color: rgb(47,86,200);color: rgb(255,255,255);"><strong>ИЛГЭЭХ</strong><br></button><button class="btn btn-primary btn-sm" type="submit" style="font-family: 'Roboto Condensed', sans-serif;background-color: rgb(47,86,200);margin: 10px;color: rgb(255,255,255);"><strong>ЗААВАР&nbsp;</strong><br></button><button class="btn btn-primary btn-sm" type="submit" style="font-family: 'Roboto Condensed', sans-serif;background-color: rgb(47,86,200);margin: 6px;color: rgb(255,255,255);height: 45px;"><strong>ТӨЛБӨР</strong>&nbsp;ТӨЛӨХ<br><strong>&nbsp;</strong><br></button></div>
                    </form>
                </div>
            </div>
        </div>
